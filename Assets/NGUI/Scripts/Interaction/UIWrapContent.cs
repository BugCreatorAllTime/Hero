...
public class UIWrapContent : MonoBehaviour
{
	...
	protected bool WrapTop = true;
	protected bool WrapBottom = true;
...
//			t.localPosition = mHorizontal ? new Vector3(i * itemSize, 0f, 0f) : new Vector3(0f, i * itemSize, 0f);
	...
	protected virtual bool UpdateItem(Transform item, int index, bool forward) { return true; }
